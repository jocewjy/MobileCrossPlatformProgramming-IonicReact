import { IonPage, IonHeader, IonToolbar, IonButtons, IonBackButton, IonTitle, IonContent, IonRow, IonCol, IonItem, IonLabel, IonInput, IonSelect, IonSelectOption, IonButton, IonIcon, IonToast } from "@ionic/react";
...
const NewMemory: React.FC = () => {
    const id = useRef<HTMLIonInputElement>(null);
    const title = useRef<HTMLIonInputElement>(null);
    const type = useRef<HTMLIonInputElement>(null);
    const [fileName, setFileName] = useState('');
    const [memories, setMemory] = useState<Array<any>>([]);
    ...
    useEffect(() => {
        async function getData(){
          ...
          setMemory(querySnapshot.docs.map((doc) => ({...doc.data(), id: doc.id})));
